...
![libvirt-nat](../images/frontline/libvirt-nat.png){:align="center"}
...
所有虚拟机获得的IP范围为`192.168.122.100-192.168.122.254`，网关为`192.168.122.1`，DNS为`192.168.122.2`，请求可转发至`8.8.8.8`或`8.8.4.4`。
