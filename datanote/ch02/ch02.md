...
![image2](../images/datanote/04-02.png)

以下图表列出了各战舰的数据，随后步骤是采用最小二乘法确定两变量间的线性关系。

![image3](../images/datanote/04-03.png)
...
![Placeholder](../images/datanote/04-04.png){: loading=lazy }
...
![image](../images/datanote/04-01.png)
...
![image](../images/datanote/svm1.png)

我们需要在中间摆一根棍子把它们分开，

![image](../images/datanote/svm2.png)

完美，那么再加点球，发现再找到一个合适位置的话比较难了（但仍然可以找到），

![image](../images/datanote/svm3.png)

SVM就是试图把棍放在最佳位置，好让在棍的两边有尽可能大的间隙，

![image](../images/datanote/svm4.png)

这根棍仍然可以分开它们，

![image](../images/datanote/svm5.png)

如果，这样摆呢？

![image](../images/datanote/svm6.png)

你怒拍桌子，将球高高弹起，然后向水果忍者那样在空中划过笔直的一刀。就这样分开了。

![image](../images/datanote/svm7.png)

那一瞬，球在另一个维度被完美分开了，像这样。

![image](../images/datanote/svm8.png)

再之后无聊的大人们，把这些球叫做data，把棍子叫做 classifier, 最大间隙的把戏叫做optimization， 拍桌子叫做kernelling, 那张纸叫做hyperplane。
